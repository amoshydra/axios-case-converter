...
var createSnakeParamsInterceptor = function createSnakeParamsInterceptor(options) {
  var _createObjectTransfor = (0, _transformers.createObjectTransformers)(options === null || options === void 0 ? void 0 : options.caseFunctions),
...
var createSnakeRequestTransformer = function createSnakeRequestTransformer(options) {
  var _createObjectTransfor2 = (0, _transformers.createObjectTransformers)(options === null || options === void 0 ? void 0 : options.caseFunctions),
      snake = _createObjectTransfor2.snake,
      header = _createObjectTransfor2.header;

  return function (data, headers) {
    if (!(options === null || options === void 0 ? void 0 : options.ignoreHeaders) && (0, _util.isPlainObject)(headers)) {
...
var createCamelResponseTransformer = function createCamelResponseTransformer(options) {
  var _createObjectTransfor3 = (0, _transformers.createObjectTransformers)(options === null || options === void 0 ? void 0 : options.caseFunctions),
